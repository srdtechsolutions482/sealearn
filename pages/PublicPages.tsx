      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center items-start text-white">
        <div className="max-w-2xl">
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6">
            Upgrade Your Maritime Skills
          </h1>
          <p className="text-xl text-gray-200 mb-8 font-light">
            Find DG Shipping–approved courses from top institutes. Enhance your
            career with our comprehensive training platform.
          </p>
          <Link to="/courses">
            <Button
              variant="accent"
              className="text-lg px-8 py-3 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all"
            >
              Explore All Courses
            </Button>
          </Link>
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <Card className="flex flex-col items-center justify-center text-center !p-10 hover:shadow-lg transition-shadow border border-gray-100">
            <div className="p-5 bg-blue-50 rounded-full mb-6">
              <PoseidonIcon className="w-8 h-8 text-primary" />
            </div>
            <h3 className="font-bold text-lg text-text-primary">
              Poseidon Training
            </h3>
          ...
          <Card className="flex flex-col items-center justify-center text-center !p-10 hover:shadow-lg transition-shadow border border-gray-100">
            <div className="p-5 bg-blue-50 rounded-full mb-6">
              <RudderIcon className="w-8 h-8 text-primary" />
            </div>
            <h3 className="font-bold text-lg text-text-primary">
              Nautical Skills Inc.
            </h3>
...
const CourseListPage: React.FC = () => {
  ...
  const filteredCourses = useMemo(() => {
    return courses
      ...
      .filter((course) =>
        filters.location ? course.location.includes(filters.location) : true
      )
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl font-extrabold text-text-primary">
                Browse Maritime Courses
              </h1>
              <p className="text-text-secondary mt-1">
                Find and enroll in DG Shipping-approved courses
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge className="bg-blue-50 text-primary border border-blue-100 px-3 py-1 cursor-pointer">
                      1-2 Days
                    </Badge>
                    <Badge className="bg-gray-50 text-text-secondary border border-gray-200 px-3 py-1 cursor-pointer">
                      3-5 Days
                    </Badge>
                    <Badge className="bg-gray-50 text-text-secondary border border-gray-200 px-3 py-1 cursor-pointer">
                      6-7+ Days
          ...
          <main className="flex-1">
            ...
            <div className="flex justify-center gap-2 mt-10">
              <button className="w-10 h-10 flex items-center justify-center rounded-lg border border-border-color bg-white hover:bg-gray-50">
                <ChevronLeftIcon />
              </button>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-border-color">
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-4">
                  {course.isDGApproved && (
                    <Badge className="bg-yellow-100 text-yellow-800 border border-yellow-200 px-3 py-1 flex items-center gap-1">
                      <svg
                        className="w-4 h-4"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                ...
                <div className="flex border-b border-border-color mb-6">
                  <button className="px-6 py-3 border-b-2 border-primary text-primary font-semibold">
                    Description
                  </button>
                  <button className="px-6 py-3 text-text-secondary hover:text-text-primary">
                    Schedule
                  </button>
                  <button className="px-6 py-3 text-text-secondary hover:text-text-primary">
                    Syllabus
                ...
                <div>
                  ...
                  <p className="text-text-secondary leading-relaxed mb-6">
                    The Basic Safety Training (BST) course is mandatory for all
                    seafarers and is designed to meet the STCW requirements.
                    This course provides essential knowledge and skills to
                    handle emergencies and ensure safety at sea. It covers
                    personal survival techniques, fire prevention and
                  ...
                  <ul className="space-y-2 text-text-secondary mb-6 list-disc list-inside">
                    <li>
                      Mastering personal survival techniques, including the use
                      of life-saving appliances.
                    </li>
                    <li>
                      Understanding the principles of fire prevention and
                      acquiring hands-on firefighting skills.
                    </li>
                    <li>
                      Administering elementary first aid in various emergency
                      situations.
                    </li>
                    <li>
                      Familiarizing with shipboard safety procedures and social
                      responsibilities.
                    </li>
                    <li>
                      Developing competence in emergency response and teamwork.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            ...
            <Card className="sticky top-24 shadow-lg border-0">
              ...
              <Button
                ...
                className="w-full !py-3 !text-base mb-4 shadow-md"
    ...
    <div className="bg-secondary min-h-screen flex items-center justify-center py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
        <h1 className="text-4xl font-bold text-text-primary mb-4">
          Thank You! Your Interest is Registered
        </h1>
        <p className="text-text-secondary text-lg mb-12">
          We have recorded your interest. You will be notified via email when
          enrollment opens for this course.
        </p>
          ...
          <div className="bg-white p-8">
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <p className="text-text-secondary mt-2">
                Please keep the booking reference for your records.
              </p>
            </div>
            ...
            <div className="space-y-6 border-t border-border-color pt-8">
              ...
              <div className="flex justify-between items-center border-t border-border-color pt-4">
                ...
                <span className="font-mono font-medium text-text-primary text-lg">
                  INT-2025-0101
                </span>
              </div>
            </div>
...
const NotFoundPage: React.FC = () => (
  <div className="bg-white flex flex-col items-center justify-center min-h-[70vh] text-center px-4">
    <h1 className="text-[180px] font-black text-primary-dark leading-none">
      404
    </h1>
    ...
    <p className="text-text-secondary max-w-md mx-auto mb-10 text-lg">
      It seems you've navigated into uncharted waters. The page you're looking
      for might have been moved, renamed, or doesn't exist.
    </p>
    <Link to="/">
      <Button
        variant="accent"
        className="px-8 py-3 text-lg rounded-lg shadow-md"
      >
        Return to Homepage
      </Button>
    </Link>
    ...
    <div className="mt-12 text-sm text-text-tertiary">
      <Link to="/contact" className="hover:text-primary mx-2">
        Contact Us
      </Link>{" "}
      |{" "}
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-30 rounded-xl">
          ...
          <p className="text-white text-lg text-center max-w-2xl">
            Our commitment to empowering seafarers with world-class, DG
            Shipping-approved training for a safer and more efficient maritime
            industry.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-8">
          <div>
            ...
            <p className="text-gray-700">
              To empower maritime professionals with accessible, innovative, and
              comprehensive training solutions that enhance safety, competence,
              and career progression. We are dedicated to providing the highest
              quality training that meets and exceeds industry standards,
              ensuring every seafarer is equipped for the challenges of the
          ...
          <div>
            ...
            <p className="text-gray-700">
              To be the leading global platform for maritime education, setting
              the benchmark for excellence and shaping the future of seafaring
              through cutting-edge technology and expert-led instruction.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mt-14 mb-8 bg-white p-8 rounded-xl shadow">
        ...
        <p className="text-center text-gray-600 mb-10">
          The principles that guide our every decision and action, ensuring we
          stay true to our mission of maritime excellence.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="flex flex-col items-center p-6 bg-gray-50 rounded-xl">
            ...
            <p className="text-gray-600 text-sm text-center">
              Prioritizing the well-being of seafarers and the marine
          ...
          <div className="flex flex-col items-center p-6 bg-gray-50 rounded-xl">
            ...
            <p className="text-gray-600 text-sm text-center">
              Striving for the highest standards in our curriculum, instruction,
              and support.
            </p>
          </div>
          <div className="flex flex-col items-center p-6 bg-gray-50 rounded-xl">
            ...
            <p className="text-gray-600 text-sm text-center">
              Embracing new technologies and teaching methods to enhance the
              learning experience.
            </p>
          </div>
          <div className="flex flex-col items-center p-6 bg-gray-50 rounded-xl">
            ...
            <p className="text-gray-600 text-sm text-center">
              Conducting our business with honesty, transparency, and a strong
              ethical compass.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto mb-16 bg-white p-8 rounded-xl shadow">
        ...
        <p className="text-center text-gray-600 mb-8">
          We provide more than just courses; we offer a pathway to a successful
          and safe maritime career.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center">
            <span
              role="img"
              aria-label="DG Shipping Approved"
            ...
            <p className="text-gray-600 text-sm text-center">
              Our courses meet the stringent standards set by the Directorate
              General of Shipping, ensuring your certification is recognized and
              valued.
            </p>
          </div>
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 text-sm text-center">
              Learn from seasoned maritime professionals with extensive
              experience at sea and in the classroom, bringing real-world
              insights to every lesson.
            </p>
          </div>
          <div className="flex flex-col items-center">
            <span
            ...
            <p className="text-gray-600 text-sm text-center">
              Our online platform allows you to learn at your own pace, anytime
              and anywhere, fitting your training around your demanding
              schedule.
            </p>
          </div>
        </div>
      ...
      <div className="bg-blue-600 rounded-xl max-w-5xl mx-auto mb-10 p-10 flex flex-col items-center text-center">
        ...
        <p className="text-white text-base mb-5">
          Join thousands of seafarers who have enhanced their skills and career
          prospects through our certified courses. Your next voyage starts here.
        </p>
        <button
          className="bg-white text-blue-600 px-6 py-2 rounded font-semibold shadow hover:bg-blue-50"
        ...
        <div className="lg:col-span-2">
          <Card className="shadow-sm border-0">
            <form className="space-y-6">
              ...
              <Button
                variant="accent"
                className="w-full sm:w-auto px-10 py-3 text-base shadow-md"
              >
                Send Message
              </Button>
            </form>
        ...
        <div className="lg:col-span-1">
          <Card className="shadow-sm border-0">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="mt-1 text-primary-dark">
                  <svg
                    className="w-6 h-6"
                    fill="none"
                    stroke="currentColor"
          ...
          <div className="mt-6 bg-blue-50 p-6 rounded-xl border border-blue-100">
            ...
            <p className="text-sm text-text-secondary mb-4">
              Browse our DG Shipping-approved catalog to find the right training
              for your career.
            </p>
            <Link to="/courses">
              <Button variant="primary-dark" className="w-full">

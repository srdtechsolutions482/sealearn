        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden lg:block">
            ...
            <input
              type="search"
              placeholder="Search"
              className="bg-secondary rounded-lg py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-primary/20 w-48"
            />
          </div>
          {isAuthenticated ? (
            <Link to="/dashboard">
  ...
  return (
    <aside className="w-64 bg-white border-r border-border-color flex flex-col">
      <div className="h-20 flex items-center gap-3 px-6 border-b border-border-color">
        <LogoAnchorIcon />
        <span className="font-bold text-text-primary">SeaLearn</span>
      </div>
      ...
      <div className="px-4 py-6 border-t border-border-color">
        <nav className="space-y-2 mb-6">
          <Link
            ...
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors text-text-secondary hover:text-primary hover:bg-secondary"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors text-text-secondary hover:text-danger hover:bg-red-50"
          >
        ...
        <Link
          to="/dashboard/profile"
          className="flex items-center gap-3 px-2 pt-2 hover:bg-secondary rounded-lg p-2 transition-colors"
        >
          <img
            src={
              user.profilePictureUrl ||
              `https://ui-avatars.com/api/?name=${user.name}&background=1D4ED8&color=fff`
            }
            alt="User avatar"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        <div>
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Empowering seafarers with world-class training. Your compass for
            career navigation at sea.
          </p>
        </div>
        <div>
          <h5 className="font-bold text-white mb-6 text-sm uppercase tracking-wider">
            Quick Links
          </h5>

...
export const CoursesIcon: React.FC<{ className?: string }> = ({
  ...
  <svg
    ...
    className={className}
  >
    <path d="M22 10v6M2 10v6M12 2v20M20.4 4.6 3.6 19.4M20.4 19.4 3.6 4.6" />
  </svg>
);
export const VendorsIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    ...
    <path d="M6 12H4a1 1 0 0 0-1 1v7h3" />
    <path d="M18 12h2a1 1 0 0 1 1 1v7h-3" />
  </svg>
);
...
export const ViewIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const SupportIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const StudentsIcon: React.FC<{ className?: string }> = ({
  ...
  >
    ...
    <path d="M14 14a2 2 0 0 0-2-2H9" />
    <path d="M4 14a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v2" />
...
export const PoseidonIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    ...
    className={className}
  >
    <path d="M14.5 20.5 9.5 10l-2 4.5" />
    <path d="m9.5 20.5 5-10.5 2 4.5" />
    <path d="M12 2v5" />
    <path d="M9 7h6" />
    <path d="M12 10a2.5 2.5 0 0 0-4 4h8a2.5 2.5 0 0 0-4-4Z" />
  </svg>
);
...
export const UploadCloudIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const SchoolIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M22 10v6M2 10v6M12 2l10 5-10 5-10-5Z" />
...
export const HourglassIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    "inline-flex items-center justify-center gap-2 rounded-lg font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
  const sizeClasses = {
  ...
  const variantClasses = {
    ...
    secondary:
      "bg-white text-text-secondary border border-border-color hover:bg-secondary focus:ring-primary",
    accent:
      "bg-accent-yellow text-primary-dark font-bold hover:bg-amber-400 focus:ring-accent-yellow",
    danger:
      "bg-white border border-danger text-danger hover:bg-danger-bg focus:ring-danger",
    success: "bg-success text-white hover:bg-green-700 focus:ring-success",
    ghost:
      "bg-transparent text-text-secondary hover:bg-secondary focus:ring-primary",
  };
  return (
    <button
...
export const Card: React.FC<CardProps> = ({ children, className }) => {
  return (
    <div
      className={`bg-white rounded-xl shadow-sm border border-border-color p-6 ${className}`}
    >
      {children}
    </div>
  );
    ...
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full ${
            icon ? "pl-10" : "px-4"
          } py-2.5 border border-border-color rounded-lg shadow-sm text-text-primary placeholder-text-tertiary focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all ${
            className || ""
          }`}
          {...props}
        />
...
export const Textarea: React.FC<TextareaProps> = ({ label, id, ...props }) => {
  return (
    <div>
      ...
      <textarea
        id={id}
        className="w-full px-4 py-2 border border-border-color rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary min-h-[100px]"
        {...props}
      />
    </div>
  );
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold ${
        statusClasses[status] || "bg-secondary text-text-secondary"
      }`}
    >
